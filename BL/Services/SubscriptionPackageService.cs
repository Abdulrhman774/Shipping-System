...
{
    public SubscriptionPackageService(IGenericRepository<TbSubscriptionPackage> repository, IBaseMapper mapper, IUserService userService, IUnitOfWork unitOfWork)
