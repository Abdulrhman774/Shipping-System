...
public class CountryController : BaseAdminController
{
    public IActionResult Index()
    {
        var model = new ManagementPageViewModel<CountryRowItem>
        {
            ...
            {
                new() { Id = Guid.NewGuid(), EnglishName = "Saudi Arabia", ArabicName = "المملكة العربية السعودية", Status = enShipmentStatus.Created, CreatedDate = "2023-01-10" },
                new() { Id = Guid.NewGuid(), EnglishName = "UAE", ArabicName = "الإمارات العربية المتحدة", Status = enShipmentStatus.Created, CreatedDate = "2023-01-12" },
                new() { Id = Guid.NewGuid(), EnglishName = "Egypt", ArabicName = "جمهورية مصر العربية", Status = enShipmentStatus.Created, CreatedDate = "2023-02-05" },
                new() { Id = Guid.NewGuid(), EnglishName = "Kuwait", ArabicName = "الكويت", Status = enShipmentStatus.Created, CreatedDate = "2023-03-20" },
                new() { Id = Guid.NewGuid(), EnglishName = "Jordan", ArabicName = "الأردن", Status = enShipmentStatus.Created, CreatedDate = "2023-04-15" }
            },
